tag @s remove new
execute store result entity @s data.resource.value.degree float 1 run random value -180..-145
execute store result entity @s data.resource.constant.degree float 0.01 run random value 1..5
execute store result entity @s data.resource.constant.radius float 1 run random value -512..-384
