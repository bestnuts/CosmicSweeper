execute store result score #math.x V run data get entity @s data.sphere.translation.[0] 100
execute store result score #math.z V run data get entity @s data.sphere.translation.[2] 100
