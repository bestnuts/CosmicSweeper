...
execute store result score #math.sin V run data get storage game main.instance.math.result.[0] -1000
execute store result score #math.cos V run data get storage game main.instance.math.result.[1] 1000
